...
print (shortestpath(graph,'w','10')) #aquí se modifica el recorrido que queremos llevar a cabo, en este caso de a - 10
...
archivo = xlsxwriter.Workbook('datos_ejecucion.xlsx')
hoja = archivo.add_worksheet()
hoja.write(0,0,"Tiempo de ejecución del programa")
